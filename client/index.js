        ...
        columns: [
            ...
            { data: 'date'},
            {
                ...
                render: function (data, type, row) {
                    const index = data.row; // Get the row index
                    return '<button type="button" class="btn btn-outline-success pin-button" onclick="handleExercisePin(' + index + ')">Pin</button>';
                }
            },
            {
                data: null,
                render: function (data, type, row) {
                    const index = data.row; // Get the row index
                    return '<button type="button" class="btn btn-danger" onclick="handleExerciseDelete(' + index + ')">Delete</button>';
                }
            }
        ]
    });
